...
function findCountryCode(country) {
    return countries.forEach((item) => {
        if (item.path === country) {
            console.log(`Country name is ${item.name} and Country Code is ${item.code}`);
        }
    })
    console.log("Couldn't find your country");
}
